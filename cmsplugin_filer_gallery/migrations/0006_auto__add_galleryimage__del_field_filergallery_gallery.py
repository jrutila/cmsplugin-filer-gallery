...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_filer_gallery_galleryimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Filer_galleria', to=orm['cmsplugin_filer_gallery.FilerGallery'])),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['filer.Image'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=-1)),
        ))
        db.send_create_signal('cmsplugin_filer_gallery', ['GalleryImage'])

        # Deleting field 'FilerGallery.gallery'
        db.delete_column('cmsplugin_filergallery', 'gallery_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FilerGallery.gallery'
        raise RuntimeError("Cannot reverse this migration. 'FilerGallery.gallery' and its values cannot be restored.")
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cmsplugin_filer_gallery.galleryimage': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Filer_galleria'", 'to': "orm['cmsplugin_filer_gallery.FilerGallery']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['filer.Image']"}),
