...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cmsplugin_filer_gallery_galleryimage', 'order')


    def backwards(self, orm):
        # Adding field 'GalleryImage.order'
        db.add_column(u'cmsplugin_filer_gallery_galleryimage', 'order',
    ...
    models = {
        ...
        u'cmsplugin_filer_gallery.filergallery': {
            'Meta': {'object_name': 'FilerGallery', '_ormbases': ['cms.CMSPlugin']},
            ...
            'height': ('django.db.models.fields.SmallIntegerField', [], {'default': '300', 'null': 'True', 'blank': 'True'}),
        ...
        u'cmsplugin_filer_gallery.galleryimage': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'GalleryImage'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': u"orm['cmsplugin_filer_gallery.FilerGallery']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
