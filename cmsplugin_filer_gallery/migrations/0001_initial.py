...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_filer_gallery_filergallery', (
            ...
            ('height', self.gf('django.db.models.fields.SmallIntegerField')(default=200, null=True, blank=True)),
            ('width', self.gf('django.db.models.fields.SmallIntegerField')(default=300, null=True, blank=True)),
            ('autoplay_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('autoplay_timeout', self.gf('django.db.models.fields.SmallIntegerField')(default=3000)),
            ('lightbox', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        db.create_table('cmsplugin_filer_gallery_galleryimage', (
            ...
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['cmsplugin_filer_gallery.FilerGallery'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='imagesss', to=orm['filer.Image'])),
